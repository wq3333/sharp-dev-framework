export const FCheckbox = {
    ...
    template: `
        <label class="inline-flex items-center gap-2 cursor-pointer select-none text-sm text-[var(--text-secondary)]" :class="{ 'opacity-40 cursor-not-allowed': disabled }">
            ...
            />
            <span class="f-checkbox__box w-4 h-4 border-[1.5px] border-[var(--border-strong)] rounded-[3px] flex items-center justify-center shrink-0 transition-all duration-150 ease-out">
