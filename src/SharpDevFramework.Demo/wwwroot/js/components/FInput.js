    ...
    template: `
        <div class="relative w-full">
            ...
            <input
                ...
                :disabled="disabled"
                :readonly="readonly"
                class="w-full px-3 py-2 bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-md text-sm text-[var(--text-primary)] leading-relaxed outline-none transition-all duration-150 ease-out placeholder:text-[var(--text-tertiary)] hover:border-[var(--border-strong)] focus:border-[var(--border-focus)] focus:shadow-[0_0_0_3px_var(--accent-subtle)]"
